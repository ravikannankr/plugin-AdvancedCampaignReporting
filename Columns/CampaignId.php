 ...
 */
class CampaignId extends VisitDimension
{
    const COLUMN_NAME = 'campaign_id';

    const COLUMN_TYPE = 'VARCHAR(100) NULL DEFAULT NULL AFTER `campaign_content`';

    const DEFAULT_URI_PARAMETERS = ['pk_cid', 'utm_id'];
